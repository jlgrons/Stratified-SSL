...
bias_200_S2 <- round(cbind(bias_sl_S2, bias_ssl_S2, bias_ssl2_S2), 2)
bias_200_S2
...
bias_400_S2 <- round(cbind(bias_sl_S2, bias_ssl_S2, bias_ssl2_S2), 2)
bias_400_S2
...
bias_200_S4 <- round(cbind(bias_sl_S4, bias_ssl_S4, bias_ssl2_S4), 2)
bias_200_S4
...
bias_400_S4 <- round(cbind(bias_sl_S4, bias_ssl_S4, bias_ssl2_S4), 2)
bias_400_S4
